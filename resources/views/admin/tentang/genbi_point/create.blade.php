    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tambah GenBI Point</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Genbi Point</h3>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.genbi_point.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control @error('link_drive') is-invalid @enderror"
                                    id="link_drive" name="link_drive" value="{{ old('link_drive') }}" required />
                                @error('link_drive')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
