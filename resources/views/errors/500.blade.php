...
@section('content')
    <!-- Hero Section -->
    <section id="error-500" class="relative h-screen flex items-center justify-center text-white md:-mt-12">
        <!-- Background Image -->
        ...
        <div class="relative z-10 text-center space-y-4">
            <h1 class="text-4xl md:text-5xl font-bold mb-10">500 | Internal Server Error</h1>
            <h1 class="text-xl md:text-2xl mb-12 pb-4 block md:hidden">Terjadi kesalahan pada server.</h1>
            <h1 class="text-xl md:text-2xl mb-12 pb-4 hidden md:block">Mohon maaf, terjadi kesalahan pada server kami.</h1>
        </div>
    </section>
@endsection
