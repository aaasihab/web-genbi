...
@section('content')
    ...
    <section id="beranda" class="relative h-screen flex items-center justify-center text-white -mt-12">
        ...
        <div class="absolute inset-0 bg-center bg-no-repeat opacity-70 block md:hidden"
            style="background-image: url('.{{ asset('templates/img/visi-misi.jpg') }}'); background-size: contain; background-position: 50% 60%;">
        </div>
    ...
    <!-- Persyaratan -->
    <section id="persyaratan-beasiswa" class="bg-gray-50 py-16">
