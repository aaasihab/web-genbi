                    ...
                    <tbody class="text-gray-700">
                        @forelse ($kegiatan as $key => $item)
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="p-3 text-center">
                                    @if ($item->gambar)
                                        <img src="{{ asset('storage/' . $item->gambar) }}" class="w-24 rounded-md shadow-md" alt="Gambar Kegiatan">
                                    @else
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="p-6 text-center text-gray-500">Tidak ada data kegiatan</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
