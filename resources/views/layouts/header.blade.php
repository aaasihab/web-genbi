...
<header id="navbar" class="fixed top-0 w-full z-50 bg-transparent text-white pt-3">
    <div class="container mx-auto flex items-center justify-between p-4">
        ...
        <nav class="hidden md:flex space-x-8 text-lg">
            ...
            <a href="{{ route('kegiatan.index') }}" class="hover:text-blue-500">Kegiatan</a>

            <!-- Beasiswa BI Dropdown -->
            <div class="dropdown relative">
                <a href="#beasiswa" class="hover:text-blue-500 flex items-center">
            ...
            <!-- Tentang Dropdown -->
            <div class="dropdown relative">
                <a href="#tentang" class="hover:text-blue-500 flex items-center">
                    Tentang <i class="fas fa-angle-down ml-2"></i>
                </a>
                <div class="dropdown-card-dekstop">
                    <a href="{{ route('genbiPoint') }}"><i class="fas fa-star"></i>GenBI Point</a>
                    <a href="{{ route('tentangGenbi') }}"><i class="fas fa-users"></i>Tentang GenBI</a>
    ...
    <nav id="mobile-menu"
        ...
        <div class="menu-items flex flex-col">
            ...
            <a href="{{ route('kegiatan.index') }}" class="py-2 hover:text-blue-500">Kegiatan</a>
            ...
            <div class="dropdown relative">
                ...
                <div class="dropdown-card-mobile hidden flex-col">
                    <a href="{{ route('genbiPoint') }}" class="py-2 px-6 hover:bg-gray-100">GenBI Point</a>
                    <a href="{{ route('tentangGenbi') }}" class="py-2 px-6 hover:bg-gray-100">Tentang GenBI</a>
                    <a href="{{ route('struktur') }}" class="py-2 px-6 hover:bg-gray-100">Struktur Organisasi</a>
                </div>
            </div>
