...
@section('content')
    ...
    <section id="beranda" class="relative h-screen flex items-center justify-center text-white -mt-12">
        ...
        <div class="relative z-10 text-center space-y-4">
            <h1 class="text-4xl md:text-5xl font-bold">Tambah link GenBI Point</h1>
        </div>
    </section>

    <!-- Form Tambah Genbi Point -->
    <section id="tambah-genbi-point" class="bg-gray-50 py-12 mt-14">
        <div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Form Tambah Genbi Point</h2>

            <form action="{{ route('genbi_point.store') }}" method="POST" class="space-y-4">
                @csrf

                <!-- Bulan -->
                <div>
                    <label for="bulan" class="block font-medium text-gray-700">Bulan</label>
                    <select name="bulan" id="bulan" @error('bulan') is-invalid @enderror
                ...
                <div>
                    ...
                    <select id="status" name="status" @error('status') is-invalid @enderror required
                ...
                <div class="flex justify-between mt-6">
                    <a href="{{ route('genbi_point.index') }}"
